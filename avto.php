        ...
        <div class="col">
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <th scope="col"><a class="btn btn-primary float-left" href="sort_avto.php?&sort"> Malumotlarni saralash </a>
                    </th>
                </tr>
                </thead>
                <tbody>
            ...
            <a href="add_avto.php?&new" class="btn btn-success">Qo'shish</a>
            <div class="row mt-4">
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        <?php for ($i = 1; $i <= getPegination("avto"); $i++) { ?>
                            <li class="page-item"><a class="page-link" href="avto.php?&page=<?= $i ?>"><?= $i ?></a>
                            </li>
                        <?php } ?>
                        <li class="page-item">
