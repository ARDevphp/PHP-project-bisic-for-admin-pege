    ...
    <div class="container-fluid">
        <div class="row mt-3">
            ...
            if (isset($_SESSION['cate'])) {
                ...
                echo "<h2 class='text-dark'>Avto kategriyasini qo'shish</h2>";
            }
            ?>
            <form method="post" action="addAvtoCate.php">
                <div class="mb-3">
                ...
                <button type="submit" name="avtoCate" class="btn btn-primary">Qo'shish</button>
            </form>
        </div>
    </div>
    <?php
