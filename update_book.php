...
if (isset($_SESSION['user'])) {
    ...
    <div class="container-fluid">
        <div class="row mt-4">
            <form method="post" action="ub_book.php">
                <div class="mb-3">
                    <label for="post_title_input" class="form-label">Kitob nomi:</label>
                    <input type="text" class="form-control px-8" name="name" value="<?= $news_row['name'] ?>"
                           id="post_title_input">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Kitob matni:</label>
                    <textarea class="form-control" name="text" id="text_name_input" rows="3"><?= $news_row['text'] ?></textarea>
                </div>
                <div>
                    <div class="mb-3">
                ...
                <button type="submit" name="book_update" class="btn btn-primary">Update</button>
            </form>
        </div>
    </div>
